...
@Document(collection="Kanban_Task")
public class Task {
    @Id
    @JsonProperty("taskId")
    ...
    public Task(String taskId, String taskTitle, String description, String status,
                String priority, Date dueDate, Date createdAt, Date updateAt, boolean isCompleted,
                String accessId, Set<String> assignedUserIds, String boardId) {
        this.taskId = taskId;
