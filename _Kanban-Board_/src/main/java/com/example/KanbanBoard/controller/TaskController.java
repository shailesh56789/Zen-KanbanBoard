...
public class TaskController
{
    ...
    @GetMapping("/findbytodostatus/{status}")
    public ResponseEntity<?> findByToDoStatus(@PathVariable String status) {

        try {
            responseEntity = new ResponseEntity<>(taskService.filterByToDoStatusS(status), HttpStatus.OK);
        } catch (Exception e) {
            responseEntity = new ResponseEntity<>(e.getMessage(), HttpStatus.INTERNAL_SERVER_ERROR);
        }
        return responseEntity;
    }
    @GetMapping("/findbyreviewstatus/{status}")
    public ResponseEntity<?> FindByReviewStatus(@PathVariable String status) {

        try {
            responseEntity = new ResponseEntity<>(taskService.filterByReviewStatusS(status), HttpStatus.OK);
        } catch (Exception e) {
            responseEntity = new ResponseEntity<>(e.getMessage(), HttpStatus.INTERNAL_SERVER_ERROR);
        }
        return responseEntity;
    }
    @GetMapping("/findbyinprogressstatus/{status}")
    public ResponseEntity<?> FindByInProgressStatus(@PathVariable String status) {

        try {
            responseEntity = new ResponseEntity<>(taskService.filterByInProgressStatusS(status), HttpStatus.OK);
        } catch (Exception e) {
            responseEntity = new ResponseEntity<>(e.getMessage(), HttpStatus.INTERNAL_SERVER_ERROR);
        }
        return responseEntity;
    }
    @GetMapping("/findbyresearchstatus/{status}")
    public ResponseEntity<?> FindByResearchStatus(@PathVariable String status) {

        try {
            responseEntity = new ResponseEntity<>(taskService.filterByResearchStatusS(status), HttpStatus.OK);
        } catch (Exception e) {
            responseEntity = new ResponseEntity<>(e.getMessage(), HttpStatus.INTERNAL_SERVER_ERROR);
        }
        return responseEntity;
    }
    @GetMapping("/findbycompletedstatus/{status}")
    public ResponseEntity<?> FindByCompletedStatus(@PathVariable String status) {

        try {
            responseEntity = new ResponseEntity<>(taskService.filterByCompletedStatusS(status), HttpStatus.OK);
        } catch (Exception e) {
            responseEntity = new ResponseEntity<>(e.getMessage(), HttpStatus.INTERNAL_SERVER_ERROR);
        }
        return responseEntity;
